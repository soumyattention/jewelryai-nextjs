...
export const metadata: Metadata = {
  title: 'AI Jewelry Photography Examples | JewelryAI',
  description: 'Browse real examples of AI-generated jewelry photography across every style and category.',
  alternates: { canonical: 'https://jewelryai.app/examples' },
  robots: { index: true, follow: true },
};

export default function ExamplesHubPage() {
  const data = loadPseoData('examples');
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Browse real examples of AI-generated jewelry photography across every style and category.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'AI Jewelry Photography Examples',
            description: 'Browse real examples of AI-generated jewelry photography across every style and category.',
            url: 'https://jewelryai.app/examples',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/examples/${item.slug}`,
              })),
            },
          }),
        }}
