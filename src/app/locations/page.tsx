...
export const metadata: Metadata = {
  title: 'AI Jewelry Photography by Location | JewelryAI',
  description: 'Find AI jewelry photography services near you. Remote service available for jewellers worldwide.',
  alternates: { canonical: 'https://jewelryai.app/locations' },
  robots: { index: true, follow: true },
};

export default function LocationsHubPage() {
  const data = loadPseoData('locations');
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            AI Jewelry Photography by Location
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Find AI jewelry photography services near you. Remote service available for jewellers worldwide.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'AI Jewelry Photography by Location',
            description: 'Find AI jewelry photography services near you. Remote service available for jewellers worldwide.',
            url: 'https://jewelryai.app/locations',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/locations/${item.slug}`,
              })),
            },
          }),
        }}
