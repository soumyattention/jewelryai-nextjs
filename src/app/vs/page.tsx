...
export const metadata: Metadata = {
  title: 'AI vs Traditional Jewelry Photography | JewelryAI',
  description: 'Side-by-side comparisons of AI photography versus traditional methods for every jewelry category. Cost, quality, speed, and scalability analysis.',
  alternates: { canonical: 'https://jewelryai.app/vs' },
  robots: { index: true, follow: true },
};

export default function ComparisonsHubPage() {
  const data = loadPseoData('comparisons');
    ...
    <div className="min-h-screen bg-white font-inter text-gray-900">
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span className="text-gray-900 font-medium">Comparisons</span>
        </nav>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Side-by-side comparisons of AI photography versus traditional methods for every jewelry category. Cost, quality, speed, and scalability analysis.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'AI vs Traditional Jewelry Photography',
            description: 'Side-by-side comparisons of AI photography versus traditional methods for every jewelry category. Cost, quality, speed, and scalability analysis.',
            url: 'https://jewelryai.app/vs',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/vs/${item.slug}`,
              })),
            },
          }),
        }}
