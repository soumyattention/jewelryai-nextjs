...
export const metadata: Metadata = {
  title: 'JewelryAI Platform Integrations | JewelryAI',
  description: 'Step-by-step guides for using AI jewelry photography with Shopify, Etsy, Amazon, and other platforms.',
  alternates: { canonical: 'https://jewelryai.app/integrations' },
  robots: { index: true, follow: true },
};

export default function IntegrationsHubPage() {
  const data = loadPseoData('integrations');
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            JewelryAI Platform Integrations
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Step-by-step guides for using AI jewelry photography with Shopify, Etsy, Amazon, and other platforms.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'JewelryAI Platform Integrations',
            description: 'Step-by-step guides for using AI jewelry photography with Shopify, Etsy, Amazon, and other platforms.',
            url: 'https://jewelryai.app/integrations',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/integrations/${item.slug}`,
              })),
            },
          }),
        }}
