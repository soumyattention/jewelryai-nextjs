...
export const metadata: Metadata = {
  title: 'Jewelry Brand Profiles | JewelryAI',
  description: 'Explore profiles of iconic jewelry brands and learn how AI photography is transforming visual standards.',
  alternates: { canonical: 'https://jewelryai.app/profiles' },
  robots: { index: true, follow: true },
};

export default function ProfilesHubPage() {
  const data = loadPseoData('profiles');
    ...
    <div className="min-h-screen bg-white font-inter text-gray-900">
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span className="text-gray-900 font-medium">Profiles</span>
        </nav>

        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            Jewelry Brand Profiles
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Explore profiles of iconic jewelry brands and learn how AI photography is transforming visual standards.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Jewelry Brand Profiles',
            description: 'Explore profiles of iconic jewelry brands and learn how AI photography is transforming visual standards.',
            url: 'https://jewelryai.app/profiles',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/profiles/${item.slug}`,
              })),
            },
          }),
        }}
