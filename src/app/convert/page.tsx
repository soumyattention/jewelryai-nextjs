...
export const metadata: Metadata = {
  title: 'Jewelry Photo Conversion Tools | JewelryAI',
  description: 'Free online tools to convert and resize your jewelry product photos. Optimised for e-commerce platforms with quality preservation.',
  alternates: { canonical: 'https://jewelryai.app/convert' },
  robots: { index: true, follow: true },
};

export default function ConvertHubPage() {
  const data = loadPseoData('conversions');
    ...
    <div className="min-h-screen bg-white font-inter text-gray-900">
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span className="text-gray-900 font-medium">Convert</span>
        </nav>

        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            Jewelry Photo Conversion Tools
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Free online tools to convert and resize your jewelry product photos. Optimised for e-commerce platforms with quality preservation.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Jewelry Photo Conversion Tools',
            description: 'Free online tools to convert and resize your jewelry product photos. Optimised for e-commerce platforms with quality preservation.',
            url: 'https://jewelryai.app/convert',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/convert/${item.slug}`,
              })),
            },
          }),
        }}
