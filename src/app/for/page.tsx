...
export const metadata: Metadata = {
  title: 'AI Photography Solutions by Role | JewelryAI',
  description: 'Tailored AI photography solutions for jewellery store owners, designers, e-commerce sellers, and marketing professionals.',
  alternates: { canonical: 'https://jewelryai.app/for' },
  robots: { index: true, follow: true },
};

export default function SolutionsHubPage() {
  const data = loadPseoData('personas');
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            AI Photography Solutions by Role
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Tailored AI photography solutions for jewellery store owners, designers, e-commerce sellers, and marketing professionals.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'AI Photography Solutions by Role',
            description: 'Tailored AI photography solutions for jewellery store owners, designers, e-commerce sellers, and marketing professionals.',
            url: 'https://jewelryai.app/for',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/for/${item.slug}`,
              })),
            },
          }),
        }}
