...
export const metadata: Metadata = {
  title: 'AI Jewelry Photography Templates | JewelryAI',
  description: 'Browse our complete collection of free AI jewelry photography templates. Professional-quality lighting, composition, and styling presets for rings, necklaces, earrings, and bracelets.',
  alternates: { canonical: 'https://jewelryai.app/templates' },
  robots: { index: true, follow: true },
};

export default function TemplatesHubPage() {
  const data = loadPseoData('templates');
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            AI Jewelry Photography Templates
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Browse our complete collection of free AI jewelry photography templates. Professional-quality lighting, composition, and styling presets for rings, necklaces, earrings, and bracelets.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'AI Jewelry Photography Templates',
            description: 'Browse our complete collection of free AI jewelry photography templates. Professional-quality lighting, composition, and styling presets for rings, necklaces, earrings, and bracelets.',
            url: 'https://jewelryai.app/templates',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/templates/${item.slug}`,
              })),
            },
          }),
        }}
