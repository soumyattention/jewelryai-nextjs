...
export const metadata: Metadata = {
  title: 'Jewelry Photography Services Directory | JewelryAI',
  description: 'Browse our curated directory of jewelry photography services by category and industry.',
  alternates: { canonical: 'https://jewelryai.app/directory' },
  robots: { index: true, follow: true },
};

export default function DirectoryHubPage() {
  const data = loadPseoData('directory');
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            Jewelry Photography Services Directory
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Browse our curated directory of jewelry photography services by category and industry.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Jewelry Photography Services Directory',
            description: 'Browse our curated directory of jewelry photography services by category and industry.',
            url: 'https://jewelryai.app/directory',
            ...
            mainEntity: {
              ...
              itemListElement: data.slice(0, 20).map((item: any, i: number) => ({
                ...
                url: `https://jewelryai.app/directory/${item.slug}`,
              })),
            },
          }),
        }}
