...
import { privateItems } from '@/lib/private-gallery-data';
...
const PrivateGallery = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState<"all" | "photos" | "videos" | "featured">("videos");
    ...
    // Use private items
    const allGalleryItems = privateItems;
        ...
        <div className="min-h-screen bg-white font-inter flex flex-col">
            ...
            <main className="flex-grow overflow-hidden pt-16 sm:pt-18 pb-16 relative z-0">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-8 sm:mb-12">
                            ...
                            <p className="text-lg sm:text-lg text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
                                A curated selection of our best work from the last 3 months that we don't usually show publicly.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div ref={galleryTopRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
                    ...
                    {selectedCategory === 'featured' && filteredItems.length < allGalleryItems.length && (
                        <div className="mt-16 text-center">
                            ...
                            >
                                ...
                                <span className="opacity-80 text-sm">({allGalleryItems.length})</span>
                            </button>
                        </div>
                    )}
